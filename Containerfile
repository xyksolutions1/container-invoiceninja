...
ARG \
    INVOICENINJA_VERSION="v5.12.41" \
    INVOICENINJA_REACT_VERSION="26.12.2025.1" \
...
ENV \
    ...
    IMAGE_NAME="xyksolutions1/invoiceninja" \
    IMAGE_REPO_URL="https://github.com/xyksolutions1/container-invoiceninja/"
